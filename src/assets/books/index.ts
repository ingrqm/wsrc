...
export default {
  ...
  [LanguageChampionship.tr]: championshipEn,
  ...
  [LanguageChampionship.fr]: {
    [Age.child]: {
      ...
      questions: {
        ...
        witchLive: `Où habite la sorcière ?`,
        storyPlace: `Où se déroule cette histoire ?`,
        witchesWant: `Que voudrait faire la sorcière de Nadia ?`,
        witchPlan: `Quel est le plan de la sorcière pour y parvenir ?`,
        nadiaFatherJob: `Quel est le métier du père de Nadia ?`,
        goToWitch: `Finalement, est-ce que Nadia va chez la sorcière ?`,
        dadsName: `Comment s’appelle le papa ?`,
        witchSpeakWithNadia: `Combien de fois La sorcière parle-t-elle avec Nadia ?`,
        nameOfLittleGirlsBrother: `Comment s’appelle le frère de la petite fille ?`,
        littleGirlsBrotherPlan: `Quel est le plan du frère de la petite fille, pour la délivrer ?`,
        whoClosesTheirEyes: `Qui ferme les yeux pour répondre à la sorcière ?`,
      },
    },
    [Age.teen]: {
      file: frTeenBook,
      ...
      questions: {
        title: `Quel est le titre ?`,
        whereAuthorStart: `Par quoi début l’auteur ?`,
        methodOffer: `Que propose cette méthode ?`,
        firstMiracle: `Quel est le premier miracle ?`,
        secondMiracle: `Quel est le second miracle ?`,
        halElrodThink: `Dans son premier chapitre, de quoi Hal Elrod, nous pense tous capables ?`,
        method: `En quoi consiste cette méthode ?`,
        authorFeelSilence: `Comment se sent l’auteur grâce au silence ?`,
        throughReading: `Grâce à la lecture ?`,
        throughAffirmations: `Grâce aux affirmations ?`,
        throughVisualization: `Grâce à la visualisation ?`,
        keepingHisDiary: `Grâce à la tenue de son journal ?`,
        physicalExercises: `Grâce aux exercices physiques ?`,
        percentageOfPeople: `D’après l’auteur, combien (en pourcentage) de personnes de notre société se contentent demoins que ce dont ils rêvent ?`,
        escapeMediocrity: `Pour échapper à cette médiocrité, que doit-on faire ?`,
        whyChange: `Pourquoi opérer le changement ?`,
        step4th: `Quelle est la 4 e étape à faire le matin ? Et pourquoi ?`,
        nameLifeSavers: `Nommer l’un des 6 life savers.`,
        timeWakeUp: `A quelle heure se réveiller le matin ?`,
        endBook: `Par quoi l’auteur termine-t-il son livre ?`,
      },
    },
    [Age.adult]: {
      file: frAdultBook,
